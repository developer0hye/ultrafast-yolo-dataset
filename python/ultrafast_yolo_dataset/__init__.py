"""Experimental label engine. Image verification/cache/Ultralytics adapter pending.
...
def parse_labels(label_paths, *, num_classes, task="detect", single_cls=False, workers=4,
