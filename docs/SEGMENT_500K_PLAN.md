...
on Linux. All output hashes match; five-pair P1, P3 and P4 are complete and audited.
See [P1](SEGMENT_500K_P1.md), [cache generation](SEGMENT_500K_STARTUP.md) and
[content-cache hits](SEGMENT_500K_HITS.md).
