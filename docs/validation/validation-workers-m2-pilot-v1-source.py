...
def series(args, state):
    ...
    state.update(
        ...
        passed=True,
        binding=binding,
        scope="Three unmeasured primers and 18 measured fresh processes across all six permutations of 4/7/16 workers. Same binary and content checks on all 500,000 image/label pairs. Worker tuning for this input-validation phase; no full-startup, new-kernel or cold-cache claim.",
    )
