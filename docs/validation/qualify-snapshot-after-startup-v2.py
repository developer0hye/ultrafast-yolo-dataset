...
PREFIX = "snapshot-startup-full-m2-v2-qualification"
...
if __name__ == "__main__":
    # Reserve exclusively outside the failure handler. An accidental rerun must
    # not replace an earlier receipt with its own FileExistsError report.
